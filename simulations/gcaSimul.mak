...
vpath_src=.. ../.. /cpp/fortify ../../../randlib/src ../../../SpatialAnalysis
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
vpath %.asm $(vpath_src)
vpath %.nsm $(vpath_src)
vpath_header=/cpp/fortify /cpp/canew /cpp/randlib/src d:/cpp/fortify\
	d:/cpp/canew d:/cpp/randlib/src /cpp/spatialanalysis\
	/cpp/canew/invasions
...
INCLUDE_DIRS=/cpp/fortify /cpp/canew /cpp/randlib/src d:/cpp/fortify\
	d:/cpp/canew d:/cpp/randlib/src /cpp/spatialanalysis\
	/cpp/canew/invasions
LIB_DIRS=
...
LIBS=grx20
LD_EXTRA_FLAGS=
C_EXTRA_FLAGS=-DGRAPHICS -DPERIODIC_BOUNDARY
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))

OBJFILES=bgi.o cabase.o CaInvaIO.o CaInvaStats.o CaSimul.o com.o fortify.o\
	linpack.o McaInva.o Period2d.o Polar2D.o randlib.o RipleyTriangle.o\
	Spec2D.o spekout.o
ALL_OBJFILES=bgi.o cabase.o CaInvaIO.o CaInvaStats.o CaSimul.o com.o\
	fortify.o linpack.o McaInva.o Period2d.o Polar2D.o randlib.o\
	RipleyTriangle.o Spec2D.o spekout.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=tes.ctl tes.inp
SRC_DIRS=.. ../.. /cpp/fortify ../../../randlib/src\
	../../../SpatialAnalysis
WUC=
EDITORS=
MAIN_TARGET=gcaSimul.exe
PROJECT_ITEMS=bgi.cpp cabase.cpp CaInvaIO.cpp CaInvaStats.cpp CaSimul.cpp\
	com.c fortify.cpp linpack.c McaInva.cpp Period2d.cpp Polar2D.cpp\
	randlib.c RipleyTriangle.cpp Spec2D.cpp spekout.cpp
DEFAULT_MASK=*.cpp
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= bgi.o cabase.o CaInvaIO.o CaInvaStats.o CaSimul.o com.o fortify.o\
	linpack.o McaInva.o Period2d.o Polar2D.o randlib.o RipleyTriangle.o\
	Spec2D.o spekout.o 
NO_LINK=
...
CaInvaIO.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
DEPS_4=CaInvaStats.cpp
CaInvaStats.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
DEPS_5=CaSimul.cpp
CaSimul.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cpp.o)
...
randlib.o:: $(DEPS_12)
	$(RHIDE_COMPILE.c.o)
DEPS_13=RipleyTriangle.cpp
RipleyTriangle.o:: $(DEPS_13)
	$(RHIDE_COMPILE.cpp.o)
DEPS_14=Spec2D.cpp
Spec2D.o:: $(DEPS_14)
	$(RHIDE_COMPILE.cpp.o)
